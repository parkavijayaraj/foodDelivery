...
<body>
    <form id="form1" runat="server" style="background-image: url('images/od1.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size:cover;">
        <div align="center">


            <table class="auto-style1">
                <tr>
                    <td colspan="3" class="auto-style7" style="text-align: left">
                      &nbsp;&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  <asp:Label runat="server" Text="Customer Details" Font-Bold="True" Font-Size="16pt" ForeColor="Black" BackColor="#FFCC00"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left" class="auto-style12">
                        <asp:TextBox ID="Txttime" runat="server" placeholder="Enter deivery Time"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" class="auto-style17">
